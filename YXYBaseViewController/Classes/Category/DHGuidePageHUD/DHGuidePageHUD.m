...
- (instancetype)dh_initWithFrame:(CGRect)frame imageNameArray:(NSArray<NSString *> *)imageNameArray buttonIsHidden:(BOOL)isHidden {
    if ([super initWithFrame:frame]) {
        ...
        // 设置引导页上的页面控制器
        self.imagePageControl = [[UIPageControl alloc]initWithFrame:CGRectMake(DDScreenW*0.0, DDScreenH*0.9, DDScreenW*1.0, 20)];
        ...
        [skipButton.titleLabel setFont:[UIFont systemFontOfSize:17.0]];
        [skipButton setBackgroundColor:[UIColor colorWithRed:33/255.0 green:23/255.0 blue:16/255.0 alpha:0.6]];
        ...
        self.btnSkip = skipButton;
        skipButton.hidden = YES;
        [skipButton mas_makeConstraints:^(MASConstraintMaker *make) {
            make.centerX.equalTo(self);
//            make.bottom.equalTo(self.imagePageControl.mas_top).offset(-20);
